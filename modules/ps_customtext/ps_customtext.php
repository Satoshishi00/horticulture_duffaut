...
class Ps_Customtext extends Module implements WidgetInterface
{
    ...
    public function installFixtures()
    {
        ...
        $tabTexts = array(
            array(
                'text' => '<h2>Bienvenue sur le site de l\'horticulture Duffaut</h2>
<p><strong class="dark">Lorem ipsum dolor sit amet conse ctetu</strong></p>
<p>Après avoir choisi vos fleurs et plantes, vous pouvez nous appeler au 05 63 32 15 25 pour passer votre commande.<br>A bientôt</p>'
            ),
        );
